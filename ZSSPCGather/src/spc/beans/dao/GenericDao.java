...
public interface GenericDao {
	...
	// public Object loadById(final Class entity, Serializable obj);
	 ...
	 /** 
	* @Title: getObjectBySql 
	* @Description: TODO(返回单一对象) 
	* @param queryName 查询名
	* @param objs 参数对象数组  
	* @return Object    返回类型 
	* @throws 
	* 2017年9月7日 上午11:07:03 最后修改人 GuveXie 
	*/
	public Object getObjectBySql(String queryName, Object[] objs);

	 /** 
	* @Title: getObjectByNativeSql 
	* @Description: TODO(返回单一对象) 
	...
	*/
	...
	public List<TSpcStandard> getListTest(String string, Object[] objects);

	public Object getByIdWithSession(Class class1, String fPid);

	public List<Object> getNativeListWithOpenSession(String sql);
}
