...
console.log(roleId);
               ...
               var demoIframe=$("#rightIframe");
                ...
                if (treeNode.isParent) {
                 ...
                 //   demoIframe.attr("src","http://www.baidu.com");
                    ...
                    demoIframe.attr("src","SelectData.html?id="+treeNode.id+"&roleId="+roleId);
                    return true;
                }
            },
  ...
  function changeFrameHeight(){
	    ...
	    ifm.width=document.documentElement.clientWidth-400;
	    console.log(ifm.width);
	    console.log(document.documentElement.clientWidth);
	    console.log(document.documentElement.clientWidth-400);
	}
