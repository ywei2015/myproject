function setTitle(){
	var value = fastDev.getInstance("message.c_msg_type").getText();
	if(value!=""){
		fastDev.getInstance("message.c_msg_title").setValue(value+"的通知");
		fastDev.getInstance("message.c_from").setValue(value);
	}else{
		fastDev.getInstance("message.c_msg_title").setValue("");
		fastDev.getInstance("message.c_from").setValue("");
	}
}
