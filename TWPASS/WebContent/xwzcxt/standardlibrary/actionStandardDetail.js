...
function handleTrigger(){
	...
	var triggerkey = fastDev.getInstance("actnode.c_iskeyctrl").getValue();
	if (triggerkey=='1'){
		showColumn();
	}
	else{
...
function showColumn() {
	...
	tb.rows[14].style.display = "block";
	tb.rows[15].style.display = "block";
	tb.rows[16].style.display = "block";
...
function hideColumn() { 
	...
	tb.rows[14].style.display = "none";
	tb.rows[15].style.display = "none";
	tb.rows[16].style.display = "none";
