 ...
 * 2017-01-20
 */
public class UBatTransToBaccoOutCabinet implements Serializable{
	...
	private String wirefeedingCode;
	private String wirefeedingName;
	...
	public String getWirefeedingCode() {
		return wirefeedingCode;
	}
	public void setWirefeedingCode(String wirefeedingCode) {
		this.wirefeedingCode = wirefeedingCode;
	}
	public String getWirefeedingName() {
		return wirefeedingName;
	}
	public void setWirefeedingName(String wirefeedingName) {
		this.wirefeedingName = wirefeedingName;
	}
