...
function initTable() {
	...
	$("#cusTable").bootstrapTable({
		...
		url : cqt_prefix + "batchMaterialTracking/batchMaterialTr", // 获取数据的Servlet地址
...
function initTable1() {
	...
	$("#cusTable1").bootstrapTable({
		method : "get", // 使用get请求到服务器获取数据
		url : cqt_prefix + "batchMaterialTracking/batchMaterialInfo", // 获取数据的Servlet地址
		pagination : true, // 启动分页
		pageSize : 5, // 每页显示的记录数
		pageNumber : 1, // 当前第几页
		pageList : [ 5, 10, 15, 20, 25 ], // 记录数可选列表
...
function initTable2() {
	...
	$("#cusTable2").bootstrapTable({
		method : "get", // 使用get请求到服务器获取数据
		url : cqt_prefix + "batchMaterialTracking/workOrderInfo", // 获取数据的Servlet地址
		pagination : true, // 启动分页
		pageSize : 5, // 每页显示的记录数
		pageNumber : 1, // 当前第几页
		pageList : [ 5, 10, 15, 20, 25 ], // 记录数可选列表
...
$(document).ready(function() {
	...
	// 当点击查询按钮的时候执行
	/*
	 * $("#search").bind("click", function(){ $('#mytable').show(); initTable();
	 * });
	 */
});
