 ...
 * 批量确认下发任务
 */
function ConfirmMultiTaskByIds(ids) {
	var proxy = fastDev.create('Proxy', {
		action : 'task_multiTaskConfirm.action'
	});
	proxy.save({taskids:ids}, function(result){
