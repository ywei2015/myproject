...
var userId=geturl("rightIframe","userId");
console.log(userId);
    ...
    $(document).ready(function(){
		...
		$.getJSON(url,function(result1){
	        ...
	        var url1  = "../../../dynamic/ObjStructure/funTreeSelectedDataForUser?userId="+userId;
    ...
    jQuery(function($){
    	$('#saveBtn').on('click',function(){
    		var treeObj = $.fn.zTree.getZTreeObj("rtree");
	         ...
	         var url  = "../../../dynamic/Security/authorizeUser";
		     $.post(url, { userId:userId , funIds:ids , treeId:id }, function(result) {
