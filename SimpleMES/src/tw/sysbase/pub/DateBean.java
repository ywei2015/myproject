...
public class DateBean {
	static SimpleDateFormat formate = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	public DateBean() {
	}
	...
	/**
	 * 将日期格式yyyyMMddHHmmss转化为 yyyy-MM-dd HH:mm:ss
	 * @throws ParseException 
	 */
	public static String timeStrToDate(String date) {
		SimpleDateFormat formate = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		SimpleDateFormat formate1 = new SimpleDateFormat("yyyyMMddHHmmss");
		Date parse;
		try {
			parse = formate1.parse(date);
			String datetime = formate.format(parse);
			return datetime;
		} catch (Exception e) {
			return date;
		}
	...
	/**
	 * 将日期格式yyyy-MM-dd HH:mm:ss转化为yyyyMMddHHmmss
	 * @throws ParseException 
	 */
	public static String dateStrToTime(String time) {
		SimpleDateFormat formate1 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		SimpleDateFormat formate = new SimpleDateFormat("yyyyMMddHHmmss");
		Date parse;
		try {
			parse = formate1.parse(time);
			String datetime = formate.format(parse);
			return datetime;
		} catch (Exception e) {
			return time;
	...
	/**
	 * 将日期格式yyyy-MM-dd HH:mm:ss转化为yyyyMMdd
	 * @throws ParseException 
	 */
	public static String dateStrToTime1(String time) {
		SimpleDateFormat formate1 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	 ...
	 * @return String
	 */
	public final static String getAfterDay(String curDate, int days) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(DateBean.dateString2Date(curDate));
		cal.add(cal.DATE, days);
		return getDateTime(cal.getTime(), "yyyyMMdd");
	...
	public final static double getIntervalMinute(String startdays, String enddays) {
		if (StingUtil.isEmpty(startdays) || StingUtil.isEmpty(enddays)) {
	...
	*@throws java.text.ParseException
	...
	public static Date convertS2Date(String text) {
