...
function onBeforeReady() {
	var initSource = "dataright_getDataRulesByPermissionId.action?permissionID=" + permissionID;
	if(userID) {
		initSource += "&userID" + userID + "&showType=user";
	} else {
		initSource += "&roleID" + roleID;
	}
	this.setOptions({
...
function doSave() {
	...
	fastDev.Ui.Window.parent.setDataRight(permissionID, ruleIds);
	doClose();
}
function doClose() {
