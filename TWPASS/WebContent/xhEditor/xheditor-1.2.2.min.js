...
function(XHEDITOR, $, undefined) {
    ...
    Xheditor = function(textarea, options) {
        ...
        this.showEmbed = function(a, b, c, d, e, f, g) {
        	//"Media", htmlMedia, "application/x-mplayer2", "clsid:6bf52a52-394a-11d3-b153-00c04f79faa6", ' enablecontextmenu="false" autostart="false"', settings.upMediaUrl, settings.upMediaExt
           console.log(11);
        	var h = $(getLang(b)),
            ...
            m.click(function() {
                ...
                if ("" !== a && "http://" !== a) {
                    ...
                    g.test(b) || (b = 412),
                    g.test(f) || (f = 300);
                    var h = '<video classid="' + d + '" controls="controls" src="xhe_tmpurl"' + e,
                    m = a.split(" ");
                    if (m.length > 1) {
                        var n, o = h + "",
                        p = [];
                        //o += ' width="xhe_width" height="xhe_height" ></video>';
                        o += ' ></video>';
                    ...
                    } else 1 === m.length && (a = m[0].split("||"), 0 === i.length && (_this.pasteHTML(h.replace("xhe_tmpurl", a[0] + "#xhe_tmpurl") + " />"), i = $('video[src$="#xhe_tmpurl"]', _doc)), xheAttr(i, "src", a[0]))
